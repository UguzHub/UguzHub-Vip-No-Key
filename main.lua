...
-- 1. DİL SEÇİM MENÜSÜ (Yukarı Kaydırılmış ve Düzenlenmiş Konum)
...
Title.Position = UDim2.new(0, 0, 0, 10) -- Roblox menüsüne çarpmaması için yukarı alındı
...
Scroll.Size = UDim2.new(0, 320, 0, 280) -- Boyut optimize edildi
Scroll.Position = UDim2.new(0.5, -160, 0.5, -120) -- Ortalandı ve yukarı kaydırıldı
...
------------------------------------------------------------
-- 2. ANA MENÜ (DAHA KÜÇÜK, SEKMELİ VE SÜPER OPTİMİZE)
------------------------------------------------------------
function buildMainMenu()
    ...
    Main.Name = "MainFrame"
    Main.Size = UDim2.new(0, 440, 0, 280) -- Daha küçük ve şık boyut
    ...
    -- Profile & Support Tab (Profil & Destek)
    local ProfBox = Instance.new("Frame")
    ProfBox.Size = UDim2.new(1, -4, 0, 135)
    ...
    UserLabel.Position = UDim2.new(0, 8, 0, 4)
    ...
    RoleLabel.Size = UDim2.new(1, -10, 0, 18)
    RoleLabel.Position = UDim2.new(0, 8, 0, 26)
    ...
    MsgLabel.Size = UDim2.new(1, -16, 0, 75)
    MsgLabel.Position = UDim2.new(0, 8, 0, 48)
...
function spawnShootButton()
    ...
    shootBtn.Size = UDim2.new(0, 100, 0, 40)
